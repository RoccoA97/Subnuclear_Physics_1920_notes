...
\begin{equation}
    ...
    \label{eq:L02_PCCE}
\end{equation}
and what we get is the \( J^{PC} \) scheme. The low-lying states of the positronium spectrum then have the \( J^{PC} \) values:
